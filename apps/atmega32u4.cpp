...
//#include "./data/free_sans_regular_16.hpp"
...
const unsigned char epd_bitmap_ecafe [] PROGMEM = {
...
int main() {
    ...
    memcpy_P(display.buffer.canvas, epd_bitmap_ecafe, sizeof(epd_bitmap_ecafe));
    g->clear(0);

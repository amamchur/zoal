...
namespace zoal { namespace metadata {
    ...
    template<>
    struct pin_to_pwm_channel<attiny13a_sign, 0x0049, 0x0036, 1> : integral_constant<int, 1> {};

    template<>
    struct pin_to_pwm_channel<attiny13a_sign, 0x0049, 0x0036, 0> : integral_constant<int, 0> {};

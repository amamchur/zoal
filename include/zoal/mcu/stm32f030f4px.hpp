...
using dma_01 = ::zoal::arch::stm32f0::dma<0x40020000, clock_ahb<0x00000001>>;

using i2c_01 = ::zoal::arch::stm32f0::i2c<0x40005400, clock_apb1<0x00200000>>;
using i2c_02 = ::zoal::arch::stm32f0::i2c<0x40005800, clock_apb1<0x00400000>>;

using spi_01 = ::zoal::arch::stm32f0::spi<0x40013000, clock_apb2<0x00001000>>;
using spi_02 = ::zoal::arch::stm32f0::spi<0x40003800, clock_apb1<0x00004000>>;
...
using timer_15 = zoal::arch::stm32f0::timer<0x40014000, clock_apb2<0x00010000>>;
...
using timer_06 = zoal::arch::stm32f0::timer<0x40001000, clock_apb1<0x00000010>>;
using timer_07 = zoal::arch::stm32f0::timer<0x40001400, clock_apb1<0x00000020>>;

using usart_01 = typename ::zoal::arch::stm32f0::usart<0x40013800, clock_apb2<0x00004000>>;
using usart_02 = typename ::zoal::arch::stm32f0::usart<0x40004400, clock_apb1<0x00020000>>;
using usart_03 = typename ::zoal::arch::stm32f0::usart<0x40004800, clock_apb1<0x00040000>>;
using usart_04 = typename ::zoal::arch::stm32f0::usart<0x40004C00, clock_apb1<0x00080000>>;
using usart_05 = typename ::zoal::arch::stm32f0::usart<0x40005000, clock_apb1<0x00100000>>;

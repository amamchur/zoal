#ifndef ZOAL_ARCH_STM32F4_TIMER_HPP
#define ZOAL_ARCH_STM32F4_TIMER_HPP
...
namespace zoal { namespace arch { namespace stm32f4 {
    ...
    public:
        ...
        using TIMERx_CCMR3 = zoal::mem::reg<Address + 0x54, zoal::mem::reg_io::read_write, uint32_t, 0xFFFFFFFF>;
        using TIMERx_CCR5 = zoal::mem::reg<Address + 0x58, zoal::mem::reg_io::read_write, uint32_t, 0xFFFFFFFF>;
        using TIMERx_CCR6 = zoal::mem::reg<Address + 0x5c, zoal::mem::reg_io::read_write, uint32_t, 0xFFFFFFFF>;

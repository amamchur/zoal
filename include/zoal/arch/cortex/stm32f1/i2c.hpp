#ifndef ZOAL_ARCH_STM32F1_I2C_HPP
#define ZOAL_ARCH_STM32F1_I2C_HPP
...
namespace zoal { namespace arch { namespace stm32f1 {
    ...
    public:
        ...
        static constexpr uint32_t I2Cx_CR1_STOP = 1 << 9; // Stop generation
        static constexpr uint32_t I2Cx_CR1_START = 1 << 8; // Start generation

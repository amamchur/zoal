...
namespace zoal { namespace arch { namespace avr { namespace atmega {
    template<
            zoal::periph::usart_data_bits Bits,
            zoal::periph::usart_parity Parity,
            zoal::periph::usart_stop_bits StopBits>
    struct atmega_usart_mode {
        static constexpr uint8_t UCSRxC_value = static_cast<uint8_t >(0)
                                                | zoal::metadata::atmega_usart_data_bits_flags<Bits>::flags
